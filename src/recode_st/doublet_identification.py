...
def process_roi_doublets(roi_name, roi_df, module_dir, cmap):
    ...
    plt.savefig(
        roi_output_dir / f"{roi_name}_transcripts_overview.pdf",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
    ...
    plt.savefig(
        roi_output_dir / f"{roi_name}_pseudocells.pdf", dpi=300, bbox_inches="tight"
    )
    plt.close()
    ...
    plt.savefig(
        roi_output_dir / f"{roi_name}_signal_integrity.pdf",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
    ...
    plt.savefig(
        roi_output_dir / f"{roi_name}_doublets_overview.pdf",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
    ...
    plt.savefig(
        roi_output_dir / f"{roi_name}_doublets_{doublet_case}.pdf",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
    ...
    plt.savefig(
        roi_output_dir / f"{roi_name}_3d_transcripts.pdf",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
