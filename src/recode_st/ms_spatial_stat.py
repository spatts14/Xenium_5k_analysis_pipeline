...
def calculate_and_plot_cross_pcf(
    ...
    # Save PCF plot
    pcf_plot_path = (
        module_dir / f"cross_pair_correlation_function_{cell_type_1}_{cell_type_2}.pdf"
    )
    ...
    vis_plot_path = module_dir / f"visualize_{cell_type_1}_{cell_type_2}.pdf"
...
def calculate_pairwise_cross_pcf(
    ...
    plt.tight_layout()
    output_path = Path(module_dir) / "cross_pair_correlation_function_all.pdf"
