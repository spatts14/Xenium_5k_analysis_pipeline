...
plots = [
    (
        ...
        "Total Cell Area (um²)",
        None,
        "total_cell_area_by_condition.svg",
    ),
    (
        "norm_transcript",
        ...
        None,
        "norm_high_Q_transcript_condition.svg",
    ),
    (
        ...
        (0, 1),
        "fraction_transcripts_decoded_q20_condition.svg",
    ),
    (
        "norm_cells",
        ...
        None,
        "norm_cells_detected_condition.svg",
    ),
    (
        ...
        (-0.001, 0.5),
        "fraction_empty_cells_condition.svg",
    ),
    (
        ...
        None,
        "median_genes_per_cell_condition.svg",
    ),
    (
        ...
        None,
        "median_transcripts_per_cell_condition.svg",
    ),
]
