...
def run_muspan(config: MuspanModuleConfig, io_config: IOConfig):
    ...
    plt.tight_layout()
    plt.savefig(module_dir / "muspan_domain_visualization.svg")
    ...
    plt.tight_layout()
    plt.savefig(module_dir / "muspan_cell_centroids.svg")
    logger.info(
    ...
    plt.tight_layout()
    plt.savefig(module_dir / "muspan_cell_centroids_n_boundaries.svg")
    logger.info(
