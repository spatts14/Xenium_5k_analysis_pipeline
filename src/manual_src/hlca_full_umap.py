...
logging.info(f"Filtered out nose cells. Remaining tissue types: {adata.obs["tissue_level_2"].unique()}")
...
sc.pl.umap(
    adata, color="tissue_coarse_unharmonized", 
